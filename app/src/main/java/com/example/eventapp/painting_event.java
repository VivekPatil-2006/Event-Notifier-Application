...
public class painting_event extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_painting_event);

        Button openGoogleButton = findViewById(R.id.painting);
